...
const FindMap = () => {
  ...
  return (
   ...
   <div className='container flex flex-col md:flex-row justify-between px-16 my-6'>

    <div className='w-full md:w-1/2 flex flex-col items-center justify-center'>
        <h1 className='font-bold text-lg md:text-2xl lg:text-4xl mb-1 white-space:nowrap'>{t('find')}</h1>
        <p className='text-sm md:text-xl mb-3'>{t('antalya')}</p>
        <h1 className='font-bold text-lg md:text-2xl lg:text-4xl mb-1 white-space:nowrap'>{t('hour')}</h1>
